...
2. Cliccare sulla tab *"Actions"* (subito sotto il titolo, in alto al centro) e verificare che il workflow `docker_build&push.yml` sia stato eseguito con successo almeno una volta.<br>
